      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _sectionHeader(
                'Personal Details', Icons.person_outline, Colors.blueAccent),
            const SizedBox(height: 12),
            _buildPersonalDetails(),
            const SizedBox(height: 20),

            _sectionHeader(
                'My Goal', Icons.flag_outlined, Colors.green),
            const SizedBox(height: 12),
            _buildGoalSection(),
            const SizedBox(height: 20),

            _sectionHeader('Assessment Results',
                Icons.analytics_outlined, _bmiColor),
            const SizedBox(height: 12),
            _buildAssessmentResult(),
            const SizedBox(height: 20),

            _sectionHeader('Exercise Recommendations',
                Icons.recommend_outlined, Colors.orange),
            const SizedBox(height: 12),
            _buildRecommendations(),
            const SizedBox(height: 20),

            _sectionHeader('Progress Tracking',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text('BMI',
                        style: TextStyle(
                            color: _bmiColor.withOpacity(0.7),
                            fontSize: 10)),
                  ],
                ),
              ),
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: selected
                  ? [
                      BoxShadow(
                          color: color.withOpacity(0.28), blurRadius: 10)
                    ]
                  : [],
            ),
            child: Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: color.withOpacity(0.18), blurRadius: 5)
                  ],
                ),
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: widget.color
                    .withOpacity(_pressed ? 0.45 : 0.18),
