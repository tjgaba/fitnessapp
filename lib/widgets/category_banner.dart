...
class CategoryBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final progress =
        category.sessionsCompleted / category.sessionsGoalPerWeek;
        ...
        children: [
          ...
          Row(
            children: [
              MetricCard(
                label: 'Sessions',
                value: '${category.sessionsCompleted}',
                sub: 'completed',
                color: color,
              ),
              const SizedBox(width: 8),
          ...
          Row(
            ...
            children: [
              ...
              Text(
                '${category.sessionsCompleted} / ${category.sessionsGoalPerWeek} sessions',
                style: TextStyle(
                    fontSize: 11,
                    color: color,
                    fontWeight: FontWeight.bold),
